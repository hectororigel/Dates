...
@section('content')
    ...
    <form  method="POST" action="/appointments">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" type="text" name="comment" id="comment" rows="3" placeholder="Comentarios">{{old('message')}}</textarea>
            </div>
        <div class="container text-center">
        <button type="submit" id="click" class="btn btn-primary" style="margin-bottom:20px">Agendar cita</button>
        </div>
